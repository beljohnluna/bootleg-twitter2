  ...
  function PostPage({ trendingResults, followResults, providers}) {
    ...
    return (
      <div>
        <Head>
          <title>
            {post?.username} on Twotter: "{post?.text}"
          </title>
        ...
        <main className="bg-white min-h-screen flex max-w-[1500px] mx-auto">
          ...
          <div className="flex-grow border-l border-r border-gray-200 max-w-2xl sm:ml-[73px] xl:ml-[370px]">
            <div className="flex items-center px-1.5 py-2 border-b border-gray-200 text-[black] font-bold text-xl gap-x-4 sticky top-0 z-50 bg-white">
              <div
